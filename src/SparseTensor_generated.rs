...
pub mod flatbuf {
  ...
  use crate::Tensor_generated::*;
  use crate::Schema_generated::*;
  use crate::Schema_generated::org::apache::arrow::flatbuf::*;
  use crate::Tensor_generated::org::apache::arrow::flatbuf::*;
  use core::mem;
  use core::cmp::Ordering;
...
impl<'a> SparseTensorIndexCOO<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.indicesBuffer { builder.add_indicesBuffer(x); }
    if let Some(x) = args.indicesStrides { builder.add_indicesStrides(x); }
    if let Some(x) = args.indicesType { builder.add_indicesType(x); }
  ...
  pub fn indicesType(&self) -> Int<'a> {
    ...
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<Int>>(SparseTensorIndexCOO::VT_INDICESTYPE, None).unwrap()}
  }
  ...
  pub fn indicesStrides(&self) -> Option<flatbuffers::Vector<'a, i64>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i64>>>(SparseTensorIndexCOO::VT_INDICESSTRIDES, None)}
  }
  ...
  pub fn indicesBuffer(&self) -> &'a Buffer {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<Buffer>(SparseTensorIndexCOO::VT_INDICESBUFFER, None).unwrap()}
  }
  ...
  pub fn isCanonical(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(SparseTensorIndexCOO::VT_ISCANONICAL, Some(false)).unwrap()}
  }
}
...
impl flatbuffers::Verifiable for SparseTensorIndexCOO<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<Int>>("indicesType", Self::VT_INDICESTYPE, true)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, i64>>>("indicesStrides", Self::VT_INDICESSTRIDES, false)?
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> SparseTensorIndexCOOBuilder<'a, 'b, A> {
  ...
  pub fn add_indicesType(&mut self, indicesType: flatbuffers::WIPOffset<Int<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Int>>(SparseTensorIndexCOO::VT_INDICESTYPE, indicesType);
  }
  #[inline]
  pub fn add_indicesStrides(&mut self, indicesStrides: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i64>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(SparseTensorIndexCOO::VT_INDICESSTRIDES, indicesStrides);
  }
  #[inline]
  pub fn add_indicesBuffer(&mut self, indicesBuffer: &Buffer) {
    self.fbb_.push_slot_always::<&Buffer>(SparseTensorIndexCOO::VT_INDICESBUFFER, indicesBuffer);
  }
  #[inline]
  pub fn add_isCanonical(&mut self, isCanonical: bool) {
    self.fbb_.push_slot::<bool>(SparseTensorIndexCOO::VT_ISCANONICAL, isCanonical, false);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> SparseTensorIndexCOOBuilder<'a, 'b, A> {
  ...
  pub fn finish(self) -> flatbuffers::WIPOffset<SparseTensorIndexCOO<'a>> {
    ...
    self.fbb_.required(o, SparseTensorIndexCOO::VT_INDICESTYPE,"indicesType");
    self.fbb_.required(o, SparseTensorIndexCOO::VT_INDICESBUFFER,"indicesBuffer");
...
impl<'a> SparseMatrixIndexCSX<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.indicesBuffer { builder.add_indicesBuffer(x); }
    if let Some(x) = args.indicesType { builder.add_indicesType(x); }
    if let Some(x) = args.indptrBuffer { builder.add_indptrBuffer(x); }
    if let Some(x) = args.indptrType { builder.add_indptrType(x); }
  ...
  pub fn compressedAxis(&self) -> SparseMatrixCompressedAxis {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<SparseMatrixCompressedAxis>(SparseMatrixIndexCSX::VT_COMPRESSEDAXIS, Some(SparseMatrixCompressedAxis::Row)).unwrap()}
  }
  ...
  pub fn indptrType(&self) -> Int<'a> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<Int>>(SparseMatrixIndexCSX::VT_INDPTRTYPE, None).unwrap()}
  }
  ...
  pub fn indptrBuffer(&self) -> &'a Buffer {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<Buffer>(SparseMatrixIndexCSX::VT_INDPTRBUFFER, None).unwrap()}
  }
  /// The type of values in indicesBuffer
  #[inline]
  pub fn indicesType(&self) -> Int<'a> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<Int>>(SparseMatrixIndexCSX::VT_INDICESTYPE, None).unwrap()}
  }
  ...
  pub fn indicesBuffer(&self) -> &'a Buffer {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<Buffer>(SparseMatrixIndexCSX::VT_INDICESBUFFER, None).unwrap()}
  }
}
...
impl flatbuffers::Verifiable for SparseMatrixIndexCSX<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<SparseMatrixCompressedAxis>("compressedAxis", Self::VT_COMPRESSEDAXIS, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<Int>>("indptrType", Self::VT_INDPTRTYPE, true)?
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> SparseMatrixIndexCSXBuilder<'a, 'b, A> {
  ...
  pub fn add_compressedAxis(&mut self, compressedAxis: SparseMatrixCompressedAxis) {
    self.fbb_.push_slot::<SparseMatrixCompressedAxis>(SparseMatrixIndexCSX::VT_COMPRESSEDAXIS, compressedAxis, SparseMatrixCompressedAxis::Row);
  }
  #[inline]
  pub fn add_indptrType(&mut self, indptrType: flatbuffers::WIPOffset<Int<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Int>>(SparseMatrixIndexCSX::VT_INDPTRTYPE, indptrType);
  }
  #[inline]
  pub fn add_indptrBuffer(&mut self, indptrBuffer: &Buffer) {
    self.fbb_.push_slot_always::<&Buffer>(SparseMatrixIndexCSX::VT_INDPTRBUFFER, indptrBuffer);
  }
  #[inline]
  pub fn add_indicesType(&mut self, indicesType: flatbuffers::WIPOffset<Int<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Int>>(SparseMatrixIndexCSX::VT_INDICESTYPE, indicesType);
  }
  #[inline]
  pub fn add_indicesBuffer(&mut self, indicesBuffer: &Buffer) {
    self.fbb_.push_slot_always::<&Buffer>(SparseMatrixIndexCSX::VT_INDICESBUFFER, indicesBuffer);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> SparseMatrixIndexCSXBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  pub fn finish(self) -> flatbuffers::WIPOffset<SparseMatrixIndexCSX<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, SparseMatrixIndexCSX::VT_INDPTRTYPE,"indptrType");
    self.fbb_.required(o, SparseMatrixIndexCSX::VT_INDPTRBUFFER,"indptrBuffer");
    self.fbb_.required(o, SparseMatrixIndexCSX::VT_INDICESTYPE,"indicesType");
    self.fbb_.required(o, SparseMatrixIndexCSX::VT_INDICESBUFFER,"indicesBuffer");
    flatbuffers::WIPOffset::new(o.value())
  }
}
...
impl<'a> SparseTensorIndexCSF<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.axisOrder { builder.add_axisOrder(x); }
    if let Some(x) = args.indicesBuffers { builder.add_indicesBuffers(x); }
    if let Some(x) = args.indicesType { builder.add_indicesType(x); }
    if let Some(x) = args.indptrBuffers { builder.add_indptrBuffers(x); }
    if let Some(x) = args.indptrType { builder.add_indptrType(x); }
    builder.finish()
  }
  ...
  pub fn indptrType(&self) -> Int<'a> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<Int>>(SparseTensorIndexCSF::VT_INDPTRTYPE, None).unwrap()}
  }
  ...
  pub fn indptrBuffers(&self) -> flatbuffers::Vector<'a, Buffer> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, Buffer>>>(SparseTensorIndexCSF::VT_INDPTRBUFFERS, None).unwrap()}
  }
  ...
  pub fn indicesType(&self) -> Int<'a> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<Int>>(SparseTensorIndexCSF::VT_INDICESTYPE, None).unwrap()}
  }
  ...
  pub fn indicesBuffers(&self) -> flatbuffers::Vector<'a, Buffer> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, Buffer>>>(SparseTensorIndexCSF::VT_INDICESBUFFERS, None).unwrap()}
  }
  ...
  pub fn axisOrder(&self) -> flatbuffers::Vector<'a, i32> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i32>>>(SparseTensorIndexCSF::VT_AXISORDER, None).unwrap()}
  }
}
...
impl flatbuffers::Verifiable for SparseTensorIndexCSF<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<Int>>("indptrType", Self::VT_INDPTRTYPE, true)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, Buffer>>>("indptrBuffers", Self::VT_INDPTRBUFFERS, true)?
     .visit_field::<flatbuffers::ForwardsUOffset<Int>>("indicesType", Self::VT_INDICESTYPE, true)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, Buffer>>>("indicesBuffers", Self::VT_INDICESBUFFERS, true)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, i32>>>("axisOrder", Self::VT_AXISORDER, true)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> SparseTensorIndexCSFBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_indptrType(&mut self, indptrType: flatbuffers::WIPOffset<Int<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Int>>(SparseTensorIndexCSF::VT_INDPTRTYPE, indptrType);
  }
  #[inline]
  pub fn add_indptrBuffers(&mut self, indptrBuffers: flatbuffers::WIPOffset<flatbuffers::Vector<'b , Buffer>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(SparseTensorIndexCSF::VT_INDPTRBUFFERS, indptrBuffers);
  }
  #[inline]
  pub fn add_indicesType(&mut self, indicesType: flatbuffers::WIPOffset<Int<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Int>>(SparseTensorIndexCSF::VT_INDICESTYPE, indicesType);
  }
  #[inline]
  pub fn add_indicesBuffers(&mut self, indicesBuffers: flatbuffers::WIPOffset<flatbuffers::Vector<'b , Buffer>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(SparseTensorIndexCSF::VT_INDICESBUFFERS, indicesBuffers);
  }
  #[inline]
  pub fn add_axisOrder(&mut self, axisOrder: flatbuffers::WIPOffset<flatbuffers::Vector<'b , i32>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(SparseTensorIndexCSF::VT_AXISORDER, axisOrder);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> SparseTensorIndexCSFBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  pub fn finish(self) -> flatbuffers::WIPOffset<SparseTensorIndexCSF<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, SparseTensorIndexCSF::VT_INDPTRTYPE,"indptrType");
    self.fbb_.required(o, SparseTensorIndexCSF::VT_INDPTRBUFFERS,"indptrBuffers");
    self.fbb_.required(o, SparseTensorIndexCSF::VT_INDICESTYPE,"indicesType");
    self.fbb_.required(o, SparseTensorIndexCSF::VT_INDICESBUFFERS,"indicesBuffers");
    self.fbb_.required(o, SparseTensorIndexCSF::VT_AXISORDER,"axisOrder");
    flatbuffers::WIPOffset::new(o.value())
  }
}
...
impl<'a> SparseTensor<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.sparseIndex { builder.add_sparseIndex(x); }
  ...
  pub fn type_type(&self) -> Type {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<Type>(SparseTensor::VT_TYPE_TYPE, Some(Type::NONE)).unwrap()}
  }
  ...
  pub fn type_(&self) -> flatbuffers::Table<'a> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Table<'a>>>(SparseTensor::VT_TYPE_, None).unwrap()}
  }
  ...
  pub fn shape(&self) -> flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<TensorDim<'a>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<TensorDim>>>>(SparseTensor::VT_SHAPE, None).unwrap()}
  }
  ...
  pub fn non_zero_length(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(SparseTensor::VT_NON_ZERO_LENGTH, Some(0)).unwrap()}
  }
  #[inline]
  pub fn sparseIndex_type(&self) -> SparseTensorIndex {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<SparseTensorIndex>(SparseTensor::VT_SPARSEINDEX_TYPE, Some(SparseTensorIndex::NONE)).unwrap()}
  }
  /// Sparse tensor index
  #[inline]
  pub fn sparseIndex(&self) -> flatbuffers::Table<'a> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Table<'a>>>(SparseTensor::VT_SPARSEINDEX, None).unwrap()}
  }
  ...
  pub fn data(&self) -> &'a Buffer {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<Buffer>(SparseTensor::VT_DATA, None).unwrap()}
  }
  #[inline]
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> SparseTensorBuilder<'a, 'b, A> {
  ...
  pub fn add_type_type(&mut self, type_type: Type) {
    self.fbb_.push_slot::<Type>(SparseTensor::VT_TYPE_TYPE, type_type, Type::NONE);
  }
  #[inline]
  pub fn add_type_(&mut self, type_: flatbuffers::WIPOffset<flatbuffers::UnionWIPOffset>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(SparseTensor::VT_TYPE_, type_);
  }
  #[inline]
  pub fn add_shape(&mut self, shape: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<TensorDim<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(SparseTensor::VT_SHAPE, shape);
  }
  #[inline]
  pub fn add_non_zero_length(&mut self, non_zero_length: i64) {
    self.fbb_.push_slot::<i64>(SparseTensor::VT_NON_ZERO_LENGTH, non_zero_length, 0);
  }
  #[inline]
  pub fn add_sparseIndex_type(&mut self, sparseIndex_type: SparseTensorIndex) {
    self.fbb_.push_slot::<SparseTensorIndex>(SparseTensor::VT_SPARSEINDEX_TYPE, sparseIndex_type, SparseTensorIndex::NONE);
  }
  #[inline]
  pub fn add_sparseIndex(&mut self, sparseIndex: flatbuffers::WIPOffset<flatbuffers::UnionWIPOffset>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(SparseTensor::VT_SPARSEINDEX, sparseIndex);
  }
  #[inline]
  pub fn add_data(&mut self, data: &Buffer) {
    self.fbb_.push_slot_always::<&Buffer>(SparseTensor::VT_DATA, data);
  }
  #[inline]
  ...
  pub fn finish(self) -> flatbuffers::WIPOffset<SparseTensor<'a>> {
    ...
    self.fbb_.required(o, SparseTensor::VT_SPARSEINDEX,"sparseIndex");
      ...
      match self.sparseIndex_type() {
        SparseTensorIndex::SparseTensorIndexCOO => {
          if let Some(x) = self.sparseIndex_as_sparse_tensor_index_coo() {
            ...
            ds.field("sparseIndex", &"InvalidFlatbuffer: Union discriminant does not match value.")
          }
        },
        SparseTensorIndex::SparseMatrixIndexCSX => {
...
pub fn size_prefixed_root_as_sparse_tensor(buf: &[u8]) -> Result<SparseTensor, flatbuffers::InvalidFlatbuffer> {
...
#[inline]
pub fn finish_size_prefixed_sparse_tensor_buffer<'a, 'b, A: flatbuffers::Allocator + 'a>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>, root: flatbuffers::WIPOffset<SparseTensor<'a>>) {
